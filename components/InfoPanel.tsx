...
const InfoPanel: React.FC<InfoPanelProps> = ({ puck, specialShotStatus = 'NONE', renderDirection = 'up', pointerHorizontalOffset = 0 }) => {
    ...
    return (
        ...
        <style>{`
            ...
            .puck-description { font-size: 0.9rem; color: var(--color-text-dark); line-height: 1.5; border-left: 3px solid var(--team-color); padding-left: 0.75rem; opacity: 0.9; }
            .puck-stats { display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem; }
            .stat-item { background: rgba(255,255,255,0.05); padding: 0.5rem; border-radius: 6px; font-size: 0.9rem; }
            .stat-item .label { color: var(--color-wood-medium); font-size: 0.75rem; display: block; margin-bottom: 0.125rem; }
