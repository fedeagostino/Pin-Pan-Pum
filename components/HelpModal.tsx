    ...
    return (
        <div className="modal-overlay" onMouseDown={handleClose}>
            <style>{`
                ...
                .help-modal {
                    background: rgba(var(--color-shadow-main-rgb), 0.8);
                ...
                .help-modal-close-btn {
                    ...
                    color: var(--color-text-light); font-size: 1.5rem; cursor: pointer;
                ...
                .help-tab-btn {
                    ...
                    color: rgba(255,255,255,0.7); font-size: clamp(0.9rem, 2.5vw, 1rem); font-weight: 600;
                    cursor: pointer; transition: all 0.2s ease; text-align: left;
                    display: flex; align-items: center; gap: 0.75rem;
                }
                .help-tab-btn svg { width: 20px; height: 20px; }
                .help-tab-btn:hover { background: rgba(255,255,255,0.1); color: white; }
                .help-tab-btn.active { 
                    background: rgba(255,255,255,0.15); color: var(--color-accent-green);
                    border-color: rgba(255,255,255,0.2);
                    box-shadow: inset 0 1px 3px rgba(0,0,0,0.3);
                }

                .help-modal-main { flex-grow: 1; display: flex; flex-direction: column; }
                .help-modal-header { padding: 1.25rem 1.5rem; border-bottom: 1px solid rgba(255,255,255,0.2); flex-shrink: 0; }
                .help-modal-title { font-size: clamp(1.25rem, 4vw, 1.75rem); font-weight: 800; color: white; }

                .help-modal-content { padding: 1.5rem; overflow-y: auto; color: var(--color-text-light); }
                ...
                .help-section h3 { font-size: clamp(1.1rem, 3.5vw, 1.3rem); font-weight: 700; color: var(--color-accent-green); margin-bottom: 1rem; }
                .help-section p { font-size: clamp(0.85rem, 2.5vw, 0.95rem); line-height: 1.6; margin-bottom: 1rem; }
                .animation-container { background: rgba(0,0,0,0.3); border-radius: 8px; padding: 1rem; margin-top: 1rem; border: 1px solid rgba(255,255,255,0.2); }
                
                .puck-list, .rules-list { display: flex; flex-direction: column; gap: 1rem; }
                .puck-info-item, .rule-item { background-color: rgba(0,0,0,0.2); padding: 1rem; border-radius: 8px; border: 1px solid rgba(255,255,255,0.2); }
                ...
                .puck-info-details p, .rule-details p { font-size: 0.85rem; color: rgba(255,255,255,0.8); line-height: 1.5; margin: 0; }
                
                .puck-stats-icons { display: flex; gap: 1rem; margin-top: 0.5rem; color: rgba(255,255,255,0.8); }
                ...
                .rule-details li { position: relative; padding-left: 1rem; font-size: 0.9rem; margin-bottom: 0.25rem; color: rgba(255,255,255,0.8); }
                .rule-details li::before { content: '•'; position: absolute; left: 0; color: var(--color-accent-purple); }
                 ...
                 @media (max-width: 768px) {
                    ...
                    .help-modal-main { border-top: 1px solid rgba(255,255,255,0.2); }
                 }
            `}</style>
